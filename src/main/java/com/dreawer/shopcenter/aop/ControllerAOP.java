package com.dreawer.shopcenter.aop;

import com.dreawer.responsecode.rcdt.Error;
import com.dreawer.responsecode.rcdt.ResponseCode;
import com.dreawer.shopcenter.exception.ResponseCodeException;
import com.dreawer.shopcenter.utils.JsonFormatUtil;
...
public class ControllerAOP {
    ...
    @Pointcut("execution(com.dreawer.responsecode.rcdt.ResponseCode com.dreawer.shopcenter.controller.*.*(..))")
